...
const routes = [
  ...
  },
  {
    ...
    children: [
      { path: '', redirect: { name: 'tenant-shop' } },
      {
        path: 'shop',
        name: 'tenant-shop',
        component: () => import('../views/tenant/ShopSetupView.vue'),
      },
      {
        path: 'products',
        name: 'tenant-products',
        component: () => import('../views/tenant/ProductsView.vue'),
      },
      {
        path: 'orders',
        name: 'tenant-orders',
        component: () => import('../views/tenant/OrdersView.vue'),
      },
      {
        path: 'subscription',
        name: 'tenant-subscription',
        component: () => import('../views/tenant/SubscriptionView.vue'),
      },
    ],
  },
  {
